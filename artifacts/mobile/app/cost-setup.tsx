...
export default function CostSetupScreen() {
  ...
  // Pre-fill monthly miles: prefer saved target, fall back to trip-computed average
  useEffect(() => {
  ...
  }, [analysis?.targetMonthlyMiles, analysis?.milesPerMonth]);
  ...
  const handleSaveMonthlyMiles = async () => {
    ...
    try {
      ...
      // silent — value still used locally for breakdown
    }
  };
                ...
                <View style={[s.cpmCard, { backgroundColor: C.card, borderColor: C.separator }]}>
                  ...
                  <View style={s.cpmMilesRow}>
                    ...
                    <TouchableOpacity
                      ...
                      style={[s.cpmSaveBtn, { backgroundColor: monthlyMilesSaved ? "#22c55e" : C.primary }]}
                    >
...
function makeStyles(C: typeof Colors.light) {
  return StyleSheet.create({
    ...
    cpmMilesRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingBottom: 4 },
