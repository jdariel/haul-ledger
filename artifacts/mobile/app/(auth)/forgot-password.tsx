        ...
        >
          ...
          {step === "done" ? (
            <View style={[s.card, { backgroundColor: C.card, borderColor: C.separator }]}>
              ...
              <Text style={[s.cardTitle, { color: C.text }]}>Password Reset!</Text>
            ...
            <View style={[s.card, { backgroundColor: C.card, borderColor: C.separator }]}>
              <Text style={[s.cardTitle, { color: C.text }]}>
                {step === "email" ? "Find your account" : "Set new password"}
              </Text>
              <Text style={[s.cardSub, { color: C.textSecondary }]}>
                {step === "email"
              ...
              {step === "email" ? (
                ...
                <>
                  ...
                  <TouchableOpacity onPress={() => { setStep("email"); setError(""); }} style={s.changeEmailBtn}>
                    <Text style={[s.changeEmailText, { color: C.textSecondary }]}>Use a different email</Text>
                  </TouchableOpacity>
                </>
              )}
            </View>
...
function makeStyles(C: typeof Colors.light) {
  return StyleSheet.create({
    ...
    changeEmailText: { fontSize: 13, fontWeight: "600" },
  });
}
