...
function getSteps(C: typeof Colors.light): Step[] {
  return [
    ...
    },
    {
      ...
      iconBg: C.greenLight,
      iconColor: C.green,
      title: "Run Your Operation Like a Business",
      subtitle: "The numbers that turn miles into more money.",
      bullets: [
        "Dashboard shows weekly income, expenses, and net profit at a glance",
        "IFTA auto-calculated by state — turn quarterly paperwork into pay-time",
        "Fleet view shows the real profit each truck and driver brings in",
      ],
